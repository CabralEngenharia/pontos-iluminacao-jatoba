...
layerSwitcher.showPanel();
    ...
    var searchLayer = new SearchLayer({
      layer: lyr_Caderneta_UniaoCOPIA_3,
      colName: 'Bairro/Povoado',
      zoom: 10,
      collapsed: true,
      map: map
    });
...
map.getView().fit([-4706577.856572, -561407.750422, -4625996.766955, -520251.570167], map.getSize());
...
map.on("rendercomplete", function(evt) {
    if (!attributionComplete) {
        ...
        qgis2webAttribution.innerHTML = '<a href="https://api.whatsapp.com/send?phone=5586994111007">Cabral Engenharia</a> &middot; ';
        var olAttribution = document.createElement('li');
        olAttribution.innerHTML = '<a href="https://instagram.com/matiascabral.eng?igshid=wkyvx2akl9d1">Matias Cabral</a> &middot; ';
